...
//        System.out.println(methodName);
        ...
        //System.out.println(this);  //BrandServlet?HttpServlet?BaseServlet
        /**
         * 如果this在BaseServlet里输出，它代表的是BrandServlet或UserServlet!
         * 谁调用我(this所在的方法),我(this)代表谁
         * BrandServlet继承自BaseServlet，service是被BrandServlet调用的（BaseServlet的子类）
         */
